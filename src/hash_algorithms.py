...
print("DEBUG")
print("\n**************************************************\n")
print("Sha1: " + sha1(test) + "\n")
print("Sha224: " + sha224(test) + "\n")
print("Sha256: " + sha256(test) + "\n")
print("sha384: " + sha384(test) + "\n")
print("sha512: " + sha512(test) + "\n")
print("Sha3_224: " + sha3_224(test) + "\n")
print("Sha3_256: " + sha3_256(test) + "\n")
print("Sha3_384: " + sha3_384(test) + "\n")
print("Sha3_512: " + sha3_512(test) + "\n")
print("Md5: " + md5(test) + "\n")
print("Blake2b: " + blake2b(test) + "\n")
print("Blake2s: " + blake2s(test) + "\n")
print("\n**************************************************\n")
'''
